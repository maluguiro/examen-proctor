...
async function resolveExamId(codeRaw) {
...
exports.questionsRouter.get("/exams/:code/questions", async (req, res) => {
    try {
        await ensureTable();
...
exports.questionsRouter.post("/exams/:code/questions", async (req, res) => {
    try {
        await ensureTable();
        const exam = await resolveExamId(req.params.code);
        if (!exam)
...
/** Editar pregunta */
exports.questionsRouter.put("/questions/:id", async (req, res) => {
    try {
        await ensureTable();
        const { id } = req.params;
...
/** Borrar pregunta */
exports.questionsRouter.delete("/questions/:id", async (req, res) => {
    try {
        await ensureTable();
        const { id } = req.params;
