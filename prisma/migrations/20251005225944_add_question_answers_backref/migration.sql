...
INSERT INTO "new_Attempt" ("endAt", "examId", "id", "livesUsed", "score", "startAt", "status", "studentId") SELECT "endAt", "examId", "id", "livesUsed", "score", "startAt", "status", "studentId" FROM "Attempt";
DROP TABLE "Attempt";
